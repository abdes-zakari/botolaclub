...
<div id="contact-area" class="contact-area section pb-90 pt-50">
    <div class="container" style="border:0px solid">
        <div class="row" style="border:0px solid">
          <h2 class="titel-page">Join Competitions</h2>
          <hr>
            ...
            <div class="col-md-2" style="border:0px solid">
               <a href="{{url('/account/game')}}?competition={{$c->id}}">
                  ...
                  <div class="row txt-competition" style="border:0px solid">
                    ...
                    <center><button type="submit" class="btn btn-block btn-prd js-play" data-id-comp="{{$c->id}}">PLAY</button></center>
                  </div>
               </a>
            </div>
        @endforeach
         ...
         <div class="col-md-2" style="border:0px solid">
               <a href="#">
                  ...
                  <div class="row txt-competition" style="border:0px solid">
                    ...
                    <center><button disabled type="submit" class="btn btn-block btn-prd js-play" data-id-comp="1">Coming Soon</button></center>
                  </div>
               </a>
            </div>
               ...
               <a href="#">
                  ...
                  <div class="row txt-competition" style="border:0px solid">
                    ...
                    <center><button disabled type="submit" class="btn btn-block btn-prd js-play" data-id-comp="3">Coming Soon</button></center>
                  </div>
               </a>
            </div>
                    <div class="col-md-2" style="border:0px solid">
               <a href="#">
                  ...
                  <div class="row txt-competition" style="border:0px solid">
                    ...
                    <center><button disabled type="submit" class="btn btn-block btn-prd js-play" data-id-comp="4">Coming Soon</button></center>
                  </div>
               </a>
            </div>
