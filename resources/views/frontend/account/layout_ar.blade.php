        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div id="main-menu" class="main-menu float-right">
                    <nav >
                        <ul >
                            <li style="float: right;"><a href="{{url('/account/home')}}" class="arabic-rtl">@lang('app.home_label')</a></li>
                            <li style="float: right;" ><a href="{{url('/account/game')}}" class="arabic-rtl">المباريات الحالية </a></li>
                            <li style="float: right;" ><a href="{{url('/account/standing')}}" class="arabic-rtl">ترتيب الدوري </a></li>
                            <!-- <li style="float: right;" ><a href="{{url('/profile/edit')}}" class="arabic-rtl">Profile </a></li> -->
                            <li style="float: right;" ><a href="{{url('/profile/'.$user->id.'/view')}}" class="arabic-rtl">الملف الشخصي </a></li>
                            <li style="float: right;" ><a href="{{url('/account/logout')}}" class="arabic-rtl">خروج</a></li>
                            <li style="float: right;" ><a href="#" class="arabic-rtl">@lang('app.contact_label')</a></li>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.21.0/locale/ar-ma.js"></script>
...
// console.log($(".arabic-time").text());
// moment.locale('fr');


// console.log(moment.locale('fr'));
// console.log(moment().locale('ar').format('dddd Do MMMM YYYY')); 
// console.log(moment($(".arabic-time").text()).locale('ar').format('dddd Do MMMM YYYY'));
// var arabic_time=moment($(".arabic-time").text()).locale('ar').format('dddd Do MMMM YYYY');
var arabic_time=moment($(".arabic-time").text()).locale('ar').format('dddd Do MMMM');

$(".arabic-time").text(arabic_time);
                ...
                success: function(data) {
                    ...
                    if (obj.scores.length>0) {
                        ...
                        for (var i = 0; i < obj.scores.length; i++) {
                            ...
                            score = obj.scores[i].score_away+" - "+obj.scores[i].score_home;
                         ...
                         $(".modal-body").append("<center><div class='container-stats arabic-rtl'>لا يوجد احصائيات لهاته المباراة </div></center>");
                    }
