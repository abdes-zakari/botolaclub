...
<div id="contact-area" class="contact-area section pb-90 pt-50">
    <div class="container">
        <h2 class="titel-page">Fixtures</h2>
    </div>
        ...
        <div class="row row-game" style="border:0px solid">
            <div class="col-lg-3 col-md-4 col-lg-offset-1 col-md-offset-1" style="border:0px solid">
                <span class="title-tab-game">
                        <span class="fa fa-chevron-left btn-next-prev prev-click"></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                        <span>  {{ $day_game }} </span>
                        <input type="hidden" name="current_date" class="current_date" value="{{ $date_now }}">
                    &nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="fa fa-chevron-right btn-next-prev next-click"></span>
                </span>
            </div>
        ...
        <div class="row row-game " style="border:0px solid">
         <input type="hidden" name="{{$count}}[id_game]" class="js-id-game" value="{{ $g->id}}">
             ...
             <div class="col-lg-2 col-md-3 col-xs-4 col-sm-4 " style="border:0px solid">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-5 " style="border:0px solid">
                        <div class="flag-home"><img class="img-size" src="{{ URL::asset('frontend/img/flags2/')}}/{{ $g->home_flag}}"></div>
                     </div>
             ...
             <div class="col-lg-2 col-md-3 col-xs-4 col-sm-4 " style="border:0px solid">
                <div class="row">
                     ...
                     <div class="col-lg-3 col-xs-offset-1 col-sm-offset-0 col-md-offset-0 col-md-3 col-sm-5 col-xs-5 " style="border:0px solid;">
                        <div class="flag-away"><img class="img-size" src="{{ URL::asset('frontend/img/flags2/')}}/{{ $g->away_flag}}"></div>
                     </div>
                </div>
             </div>
             ...
             <div class="col-lg-1 col-md-1 col-xs-3 col-sm-2 " style="border:0px solid">
                <div class="infos">
                    <span class="show-on-min">result:</span>
...
@endforeach
        ...
        <div class="row row-game " style="border:0px solid">
             <div class="col-lg-3 col-md-4 col-xs-6 col-sm-5 col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3" style="border:0px solid">
                 <button type="submit" class="btn btn-block btn-prd" id="js-save-game">SAVE</button>
             </div>
        </div>
</form>

<!-- The Modal -->
<div class="modal fade" id="show-stats">
  <div class="modal-dialog center-modal">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-prd" data-dismiss="modal">Close</button>
      </div>
