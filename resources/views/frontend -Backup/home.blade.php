            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="hero-content col-md-10 col-xs-12" style="border:0px solid">
                        <h1>Predict, <span>World CUP 2018</span></h1>
                        ...
                        <a href="#next-match-area" data-toggle="modal" data-target="#login-modal">Login </a>
      ...
      <div class="modal-body">
        <form method="POST" action="{{url('/account/check')}}">
          ...
          <div class="form-group">
            ...
            <input type="email" name="email" class="form-control input-text-prd" id="email_login" placeholder="Email" value="abdes@gmail.com">
          </div>
          <br>
          <div class="form-group">
        ...
        <div class="row"  style="border:0px solid">
            ...
            <div class="about-content col-md-8 col-md-offset-1  col-xs-12 " style="border:0px solid">
                ...
                <form class="form-horizontal frm-prd" method="POST" action="{{url('/account/register')}}">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="username" class="col-sm-4 control-label label-txt">Username</label>
                      <div class="col-sm-8">
                    ...
                    <br>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-4 control-label label-txt">Email</label>
                      <div class="col-sm-8">
                    ...
                    <br>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-4 control-label label-txt">Password</label>
                      <div class="col-sm-8">
                    ...
                    <br>
                    <div class="form-group">
                      <label for="inputPassword4" class="col-sm-4 control-label label-txt">Confirm Password</label>
                      <div class="col-sm-8">
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-4 col-sm-8">
                        <button type="submit" class="btn btn-default btn-prd">Sign up</button>
                      </div>
                    </div>
                </form>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                ...
                <div class="upcoming-match">
                    ...
                    <div class="teams">
                        <div class="nms-team">
                            <div class="image float-left"><img src="#" alt=""></div>
                            <h4>Abahani</h4>
                        </div>
                        <span class="vs">vs</span>
                        <div class="nms-team">
                            <h4>Brothers</h4>
                            <div class="image float-right"><img src="#" alt=""></div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row row-10">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="img/gallery/big-1.jpg" class="gallery-item overlay gallery-popup"><img src="#" alt=""></a>
            </div>
            <!-- Single Gallery Image -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="img/gallery/big-2.jpg" class="gallery-item overlay gallery-popup"><img src="#" alt=""></a>
            </div>
            <!-- Single Gallery Image -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="img/gallery/big-3.jpg" class="gallery-item overlay gallery-popup"><img src="#" alt=""></a>
            </div>
            <!-- Single Gallery Image -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="img/gallery/big-4.jpg" class="gallery-item overlay gallery-popup"><img src="#" alt=""></a>
            </div>
            <!-- Single Gallery Image -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="img/gallery/big-5.jpg" class="gallery-item overlay gallery-popup"><img src="#" alt=""></a>
            </div>
            <!-- Single Gallery Image -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="img/gallery/big-6.jpg" class="gallery-item overlay gallery-popup"><img src="#" alt=""></a>
            </div>
        </div>
    </div>
</div>
