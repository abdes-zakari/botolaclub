                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            Hello
                                            <br>
                                            To reset the password to your BotolaClub account, click the link below:

                                             <br><br>
                                              <div style="background-color:#eb2d3a;width:250px;padding:15px;">
                                                  <a href="{{url('/account/reset')}}?token={{$token}}" style="color: #ffffff; text-decoration: none;font-weight: bold;">RESET PASSWORD</a>
                                              </div>
                                             <br><br>
                                               <a href="{{url('/account/reset')}}?token={{$token}} ">{{url('/account/reset')}}?token={{$token}} </a>
                                               <br>
